...
public class RabbitMqXmlController {
    ...
    public String saveMessage(@RequestBody TrainRequest trainRequest) {
        log.info(">> Start RabbitMqXmlController :- saveMessage()");
        if (null != trainRequest.getTrainId()) {
            rabbitMqXmlService.persist(trainRequest);
        }
        log.info("<< End RabbitMqXmlController :- saveMessage()");
        return "Success";
    }
    ...
    public void messageFromListener(@RequestBody TrainRequest trainRequest) {
        log.info(">> Start RabbitMqXmlController :- messageFromListener()");
        ...
        log.info("<< End RabbitMqXmlController :- messageFromListener()");
